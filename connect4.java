...
public class connect4 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Player 1: RED DISC\n");
		System.out.println("Player 2: BLACK DISC\n");
		System.out.println("-------------------------------------------------------------------------\n");
		System.out.println("|| Please choose the column to place your colored disc turn by turn! ||\n");
		System.out.println("-------------------------------------------------------------------------\n");
